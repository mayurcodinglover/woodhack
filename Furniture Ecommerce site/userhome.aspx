<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userhome.aspx.cs" Inherits="Furniture_Ecommerce_site.userhome" %>
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <asp:Button ID="btnlogin" runat="server" Text="Login" CssClass="btn btn navbar-default navbar-btn" OnClick="btnlogin_Click" />
                                <asp:Button ID="btnlogout" runat="server" Text="Logout" CssClass="btn btn navbar-default navbar-btn" OnClick="btnlogout_Click" />
                            </li>
